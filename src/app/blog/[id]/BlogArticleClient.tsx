    ...
    <div key={post.id} className="min-h-screen bg-theme-page text-theme-text font-mono">
      ...
      <main className="container mx-auto p-4 mb-16">
        <div className="max-w-3xl mx-auto">
          <Link
            href="/blog"
            className="text-theme-text hover:text-theme-text-heading mb-8 inline-block"
          >
            ← Back to Blog
          </Link>
          ...
          <article className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {post.tags.map((tag) => (
                <span
                  key={tag}
                  className="bg-theme-accent-muted text-theme-text px-3 py-1 rounded-full text-sm"
                >
                  {tag}
                </span>
              ))}
            ...
            {post.id === "2025-16-06-new-digital-piece" && (
              <div className="mt-8">
                ...
                <VideoPlayer src="/videos/shred1.mp4" title="heres some shred" />
                <p className="text-sm text-theme-text-muted mt-2 italic">
                  song: xaviersobased - dancer
                </p>
              </div>
            )}
          </article>
