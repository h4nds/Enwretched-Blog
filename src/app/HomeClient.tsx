  ...
  return (
    <div className="min-h-screen text-purple-200 font-mono relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/images/showcase/435-hz.jpg)',
        }}
      />
        ...
        <main className="container mx-auto px-4 py-6">
          ...
          <section className="mt-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-purple-300">Featured Artworks</h2>
              <Link 
                href="/gallery" 
                className="text-purple-200 hover:text-purple-100 text-sm border border-purple-900 px-4 py-2 rounded-lg hover:bg-purple-900/30 transition-colors"
              >
                View All →
              </Link>
            </div>
          ...
          <section className="mt-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-purple-300">Recent Blog Posts</h2>
              <Link 
                href="/blog" 
                className="text-purple-200 hover:text-purple-100 text-sm border border-purple-900 px-4 py-2 rounded-lg hover:bg-purple-900/30 transition-colors"
              >
